...
import { fetchCannedResponses, createCannedResponse,  apiTemplateError, apiTemplateSuccess, updateCannedResponse, deleteCannedResponse } from '../redux/actions';
...
export default function CannedResponseCard(props) {
    ...
    const cannedResponses = useSelector((state) => state.Templates.cannedResponses); // Original data


    const [searchTerm, setSearchTerm] = useState('');
    const [filteredCannedResponses, setFilteredCannedResponses] = useState(cannedResponses);
    const [createCannedResponseModal, setCreateCannedResponseModal] = useState(false);
    const [updateCannedResponseModal, setUpdateCannedResponseModal] = useState(false);
    ...
    const tableInstance = useTable({ columns, data: filteredCannedResponses });
