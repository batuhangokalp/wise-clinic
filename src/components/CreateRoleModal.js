...
export default function CreateRoleModal(props) {
    ...
    let { modal, toggleModal, validationSchema, handleSubmit, selectedRole, parentProps } = props;
    ...
    return (
        <Modal isOpen={modal} centered toggle={toggleModal}>
            ...
            <ModalBody className="p-4">
                <Formik
                    initialValues={{role_name: "", role_description: ""}}
                        ...
                        <FormikForm>
                            ...
                            <div className="mb-4">
                                ...
                                {errors.role_description && touched.role_description && (
                                    <span className="mt-2 text-danger">{errors.role_description}</span>
                                )}
                            </div>
