        ...
        <React.Fragment>
            <div style={{ display: (props.userSidebar === true) ? "block" : "none" }} className="user-profile-sidebar">
                ...
                <div className="text-center p-4 border-bottom">
                    ...
                    <div className="mb-4 d-flex justify-content-center">
                        {
                            props.contact?.avatar ?
                                <img src={props.contact?.avatar} className="rounded-circle avatar-lg img-thumbnail" alt="chatvia" />
                                :
                    ...
                    <h5 className="font-size-16 mb-1 text-truncate">{props.contact?.name}</h5>
                        ...
                        <Card className="shadow-none border mb-2">
                            ...
                            >
                                ...
                                <div className="mt-4">
                                    ...
                                    <h5 className="font-size-14">{props.contact?.birth_date ? dayjs(props.contact?.birth_date).format("DD.MM.YYYY") : "-"}</h5>
                                </div>

                                <div className="mt-4">
                                    <p className="text-muted mb-1">{t('Email')}</p>
                                    <h5 className="font-size-14">{props.contact?.contact_email}</h5>
                                </div>

                                <div className="mt-4">
                                    <p className="text-muted mb-1">{t('Phone Number')}</p>
                                    <h5 className="font-size-14">{props.contact?.phone_number}</h5>
                                </div>

                                <div className="mt-4">
                                    <p className="text-muted mb-1">{t('Country')}</p>
                                    <h5 className="font-size-14">{props.contact?.country ? getCountryData(props.contact?.country) : "-"}</h5>
                                </div>

                                <div className="mt-4">
                                    <p className="text-muted mb-1">{t('Sex')}</p>
                                    <h5 className="font-size-14">{props.contact?.sex ? getSexValue(props.contact?.sex) : "-"}</h5>
                                </div>
                                <div className="mt-4">
                                    <p className="text-muted mb-1">{t('Instagram User Id')}</p>
                                    <h5 className="font-size-14">{props.contact?.instagram_user_id ? props.contact?.instagram_user_id : "-"}</h5>
                                </div>
                                <div className="mt-4">
                                    <p className="text-muted mb-1">{t('Facebook User Id')}</p>
                                    <h5 className="font-size-14">{props.contact?.facebook_user_id ? props.contact?.facebook_user_id : "-"}</h5>
                                </div>
                            </CustomCollapse>
                        </Card>
                        {/* End About card */}
