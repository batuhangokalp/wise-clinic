...
import { fetchTemplates, createTemplate, apiTemplateError, apiTemplateSuccess, updateTemplate, deleteTemplate } from '../redux/actions';
...
export default function TemplatesCard(props) {
    ...
    const tableInstance = useTable({ columns, data: filteredTemplates });
