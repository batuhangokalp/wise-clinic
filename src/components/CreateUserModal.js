...
import { Modal, ModalHeader, ModalBody, ModalFooter, Button, Label, Alert, Col } from "reactstrap";
import { Formik, Form as FormikForm, Field } from "formik";
import { countryList } from "../helpers/countryList";
import { useDispatch, useSelector } from "react-redux";
import dayjs from "dayjs";
import { sexList } from "../helpers/sexList";
import { fetchRoles, fetchLanguages, fetchDepartments, fetchPositions } from "../redux/actions";
...
export default function CreateUserModal(props) {
    ...
    let { modal, toggleModal, validationSchema, handleSubmit, selectedUser, parentProps } = props;
                                ...
                                <Col md={5}>
                                    ...
                                    <div className="mb-4">
                                        ...
                                        {errors.password && touched.password && (
                                            <span className="mt-2 text-danger">{errors.password}</span>
                                        )}
                                    </div>
                                ...
                                <Col md={5}>
                                    ...
                                    <div className="mb-4">
                                        ...
                                        {errors.language_id && touched.language_id && (
                                            <span className="mt-2 text-danger">{errors.language_id}</span>
                                        )}
                                    </div>
                                    ...
                                    <div className="mb-4">
                                        ...
                                        {errors.position && touched.position && (
                                            <span className="mt-2 text-danger">{errors.position}</span>
                                        )}
                                    </div>
                                    ...
                                    <div className="mb-4">
                                        ...
                                        {errors.department && touched.department && (
                                            <span className="mt-2 text-danger">{errors.department}</span>
                                        )}
                                    </div>
                                            ...
                                            {({ field, form }) => (
                                                <div className="form-check form-switch">
                                                    ...
                                                    <label className="form-check-label" htmlFor="is_active">
                                                        {field.value ? parentProps.t('Active') : parentProps.t('Inactive')}
                                                    </label>
                                                </div>
                                            )}
                                        </Field>
                                        {errors.is_active && touched.is_active && (
                                            <span className="mt-2 text-danger">{errors.is_active}</span>
                                        )}
                                    </div>
                                    ...
                                    <div className="mb-4">
                                        ...
                                        {errors.birth_date && touched.birth_date && (
                                            <span className="mt-2 text-danger">{errors.birth_date}</span>
                                        )}
                                    </div>
                                </Col>
                            </div>
