...
import {
    ...
    FETCH_CANNED_RESPONSE_BY_ID_FAILURE, SET_SELECTED_CANNED_RESPONSE,
    API_SUCCESS, API_ERROR, CREATE_TEMPLATE, UPDATE_TEMPLATE, DELETE_TEMPLATE, CREATE_CANNED_RESPONSE, UPDATE_CANNED_RESPONSE, DELETE_CANNED_RESPONSE
...
export const fetchTemplateById = (id) => {
    return async (dispatch) => {
        ...
        try {
            const response = await fetch(`${process.env.REACT_APP_API_URL}/api/templates/${id}`, {
                headers: {
                    "Accept": "*/*",
...
export const fetchCannedResponses = () => {
    return async (dispatch) => {
        ...
        try {
            const response = await fetch(`${process.env.REACT_APP_API_URL}/api/canned-responses`, {
                headers: {
                    "Accept": "*/*",
                    "Accept-Encoding": "gzip, deflate",
                    "User-Agent": "Mozilla/5.0 (Windows NT 6.1; Win64; x64; rv:47.0) Gecko/20100101 Firefox/47.0",
...
export const fetchCannedResponseById = (id) => {
    return async (dispatch) => {
        ...
        try {
            const response = await fetch(`${process.env.REACT_APP_API_URL}/api/canned-responses/${id}`, {
                headers: {
                    "Accept": "*/*",
                    "Accept-Encoding": "gzip, deflate",
                    "User-Agent": "Mozilla/5.0 (Windows NT 6.1; Win64; x64; rv:47.0) Gecko/20100101 Firefox/47.0",
...
export const updateTemplate = (template) => {
    return async (dispatch) => {
        try {
            const response = await fetch(`${process.env.REACT_APP_API_URL}/api/templates/${template.id}`, {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json',
                    "Accept": "*/*",
...
export const updateCannedResponse = (cannedResponse) => {
    return async (dispatch) => {
        try {
            const response = await fetch(`${process.env.REACT_APP_API_URL}/api/canned-responses/${cannedResponse.id}`, {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json',
                    "Accept": "*/*",
...
export const deleteCannedResponse = (cannedResponseId) => {
    return async (dispatch) => {
        try {
            const response = await fetch(`${process.env.REACT_APP_API_URL}/api/canned-responses/${cannedResponseId}`, {
                method: 'DELETE',
                headers: {
                    "Accept": "*/*",
                    "Accept-Encoding": "gzip, deflate",
