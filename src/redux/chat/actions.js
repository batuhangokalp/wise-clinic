import {
  ...
  FETCH_CONVERSATION_BY_ID_REQUEST,
  FETCH_CONVERSATION_BY_ID_SUCCESS,
  FETCH_CONVERSATION_BY_ID_FAILURE,
  SET_ACTIVE_CONVERSATION_ID,
  SET_ACTIVE_CONVERSATION,
  FETCH_ALL_LAST_MESSAGES_REQUEST,
  FETCH_ALL_LAST_MESSAGES_SUCCESS,
  FETCH_ALL_LAST_MESSAGES_FAILURE,
  SEND_MESSAGE_REQUEST,
  SEND_MESSAGE_SUCCESS,
  SEND_MESSAGE_FAILURE,
  FETCH_MESSAGES_BY_CONVERSATION_ID_FAILURE,
  FETCH_MESSAGES_BY_CONVERSATION_ID_REQUEST,
  FETCH_MESSAGES_BY_CONVERSATION_ID_SUCCESS,
  SET_CHAT_MESSAGES,
  SET_CHAT_FILE,
  SET_CONVERSATIONS,
  SET_CHAT_MESSAGES_PAGE,
  SET_CHAT_MESSAGES_LIMIT,
  SET_CONVERSATIONS_PAGE,
  SET_CONVERSATIONS_LIMIT,
  SET_TEXT_MESSAGE,
  UPLOAD_FILE_REQUEST,
  UPLOAD_FILE_SUCCESS,
  UPLOAD_FILE_FAILURE,
...
export const fetchConversations = (limit = 10, page = 1) => {
  return async (dispatch) => {
    ...
    try {
      const response = await fetch(
        `${process.env.REACT_APP_API_URL}/api/conversations?limit=${limit}&page=${page}`,
        {
          headers: {
            Accept: "*/*",
            "Accept-Encoding": "gzip, deflate",
  ...
  return async (dispatch) => {
    ...
    try {
      ...
      for (let i = 0; i < updatedConversations.length; i++) {
        const response = await fetch(
          `${process.env.REACT_APP_API_URL}/api/messages/${updatedConversations[i]?.last_message_id}`,
          {
            headers: {
              Accept: "*/*",
              "Accept-Encoding": "gzip, deflate",
