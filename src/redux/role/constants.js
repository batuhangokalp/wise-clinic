...
export const PERMISSION_MAP = {
  "Own Chat": [PERMISSIONS.VIEW_ASSIGNED_CHATS, PERMISSIONS.VIEW_CHATS_PANEL],
  "All Chats": [PERMISSIONS.VIEW_ALL_CHATS, PERMISSIONS.VIEW_CHATS_PANEL],
  Settings: [
    PERMISSIONS.VIEW_SETTINGS_PANEL,
  ...
  Contacts: [PERMISSIONS.VIEW_CONTACTS_PANEL, PERMISSIONS.VIEW_CONTACTS],
  Reports: [PERMISSIONS.VIEW_REPORTS_PANEL, PERMISSIONS.VIEW_REPORTS],
  Profile: [PERMISSIONS.VIEW_PROFILE_PANEL],
};
