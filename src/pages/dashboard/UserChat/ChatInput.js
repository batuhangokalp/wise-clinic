...
function ChatInput(props) {
  ...
  /* intilize t variable for multi language implementation */
    ...
    const toggleTemplatePicker = () => setisTemplatePickerOpen(!isTemplatePickerOpen);
    ...
    const [showSendTemplateMessageModal, setShowSendTemplateMessageModal] = useState(false);
                        ...
                        <div className="chat-input-links ms-md-2">
                            <ul className="list-inline mb-0 ms-0">
                                <li className="list-inline-item">
                                    <ButtonDropdown className="template-dropdown" direction="up" isOpen={isTemplatePickerOpen} toggle={toggleTemplatePicker}>
                                        <DropdownToggle id="template" color="link" className="text-decoration-none font-size-16 btn-lg waves-effect">
                                            <i className="ri-command-line"></i>
                                        </DropdownToggle>
                                        <DropdownMenu className="dropdown-menu-end">
                                            <TemplatePicker handleTemplateSelect={handleTemplateSelect} />
                                        </DropdownMenu>
                                    </ButtonDropdown>
